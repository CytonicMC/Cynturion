...
public final class DurationParser {
     ...
     * `-1` provides a null, representing a permanent value
     *
     * @param input The string to parse the value from
     * @return null if the duration is permanent, returns {@link Instant#now()} if the input doesn't contain any parsable data, or an {@link Instant} with the specified duration from now.
     */
    @Nullable
